...
<!-- CUSTOM SOCIAL LINKS -->
        ...
        <div class="socials">
				<a href="http://facebook.com/crosswalkworship" class="facebook" data-title="Facebook" target="_blank"><span class="font-icon-social-facebook"></span></a>
                <a href="https://twitter.com/cwllumc" class="twitter" data-title="Twitter" target="_blank"><span class="font-icon-social-twitter"></span></a>
                <a href="http://instagram.com/cwllumc" class="instagram" data-title="instagram" target="_blank"><span class="fa fa-instagram"></span></a>
