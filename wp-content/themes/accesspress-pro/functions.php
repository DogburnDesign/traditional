...
function accesspress_pro_setup() {
	 ...
	 * to change 'accesspress_pro' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'accesspress_pro', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'accesspress_pro' ),
	) );
