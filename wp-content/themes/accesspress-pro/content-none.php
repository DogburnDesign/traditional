...
<section class="no-results not-found">
	<header class="archive-header">
		<h2 class="archive-title"><?php _e( 'Nothing Found', 'accesspress_pro' ); ?></h2>
	</header><!-- .page-header -->
	...
	<div class="entry-content">
		...
		<?php elseif ( is_search() ) : ?>
			...
			<p><?php _e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'accesspress_pro' ); ?></p>
