...
if($accesspress_pro_tc_activate == 1){
...
$accesspress_pro_featured_bar = $accesspress_pro_settings['featured_bar'];
...
<?php if(!empty($accesspress_pro_calltoaction_text)):?>
...
<?php 
if(!empty($accesspress_pro_featured_post1) || !empty($accesspress_pro_featured_post2) || !empty($accesspress_pro_featured_post3) || !empty($accesspress_pro_featured_post4)){
    ...
    if(!empty($$accesspress_pro_featured_post)) { ?>
		<div id="featured-post-<?php echo $accesspress_pro_featured_post_count; ?>" class="featured-post featured-post-<?php echo $accesspress_pro_featured_post_count; if($accesspress_pro_big_icons == 1){ echo ' big-icon'; } ?>">
...
if ( is_active_sidebar( 'textblock-1' ) || is_active_sidebar( 'textblock-2' ) || is_active_sidebar( 'textblock-3' )) :
	if($accesspress_pro_featured_bar != 1): ?>
	<section id="bottom-section">
		<div class="ak-container <?php echo accesspress_pro_featuredcolumn(); ?>">
