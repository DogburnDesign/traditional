jQuery(document).ready(function($){
        ...
        if($('#slider_type1').is(':checked')){
               $(".img-image, .upload-slider-image" ).css('display','inlineblock');
            }else{
               $(".img-image, .upload-slider-image" ).css('display','none');
            }
         
        $( ".slider-mode input" ).change(function() {
                    if($(this).attr('id')=='slider_type1'){
                            $(".img-image, .upload-slider-image" ).css('display','inlineblock');
                    }else{
                            $(".img-image, .upload-slider-image" ).css('display','none');
                    }
            ...
            $( "#featured_post_count" ).change(function() {
                    if($( "#featured_post_count option:selected" ).val()=='4'){
                            $(".featured_post_4_option" ).fadeIn();
                    }else{
                            $(".featured_post_4_option" ).fadeOut();
                    }
            }).change();
        ...
        $('#add-slider').click(function(){
          ...
          '<img class="img-banner" src="" alt="slider-banner" style="display:none"/>'+
          '<img class="img-image" src="" alt="slider-image" style="display:none"/>'+
