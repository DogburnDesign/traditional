 ...
 */
function accesspress_pro__admin_scripts() {
wp_enqueue_script( 'admin-js', get_template_directory_uri() . '/inc/admin-panel/js/admin.js', array('jquery'), '1', true );
}
add_action( 'admin_enqueue_scripts', 'accesspress_pro__admin_scripts' );
...
function accesspress_pro_add_mce_button() {
...
add_action('admin_head', 'accesspress_pro_add_mce_button');

// Declare script for new button
function accesspress_pro_add_tinymce_plugin( $plugin_array ) {
	$plugin_array['accesspress_pro_mce_button'] = get_template_directory_uri() .'/inc/admin-panel/js/shortcodes.js';
	return $plugin_array;
}
...
$testimonial = '<div class="testimonial-block">'; 
if($image):
$testimonial .= '<div class="testimonial-image'.' '.$image_shape.'"><img src="'.$image.'"/></div>';
endif;
if($content):
$testimonial .= '<div class="testimonial-content">'.ap_content_helper($content).'</div>';
endif;
