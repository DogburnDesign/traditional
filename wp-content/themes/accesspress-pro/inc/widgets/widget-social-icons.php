...
class Accesspress_Pro_Social_Icons extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
	 		'accesspress_pro_social_icons',
			'AP : Social Icons',
			array(
				'description'	=> __( 'Display links to your social network profiles, enter full profile URLs', 'accesspress' )
			)
		);
	}
	 ...
	 private function widget_fields() {
		$fields = array(
			...
			'widget_title' => array(
				...
				'accesspress_pro_widgets_title'			=> __( 'Title', 'accesspress' ),
			...
			'twitter' => array (
				...
				'accesspress_pro_widgets_title'			=> __( 'Twitter', 'accesspress' ),
				'accesspress_pro_widgets_field_type'		=> 'text'
			),
			'facebook' => array (
				'accesspress_pro_widgets_name'			=> 'facebook-square',
				'accesspress_pro_widgets_title'			=> __( 'Facebook', 'accesspress' ),
				'accesspress_pro_widgets_field_type'		=> 'text'
			),
			'linkedin' => array (
				'accesspress_pro_widgets_name'			=> 'linkedin-square',
				'accesspress_pro_widgets_title'			=> __( 'LinkedIn', 'accesspress' ),
				'accesspress_pro_widgets_field_type'		=> 'text'
			),
			'gplus' => array (
				'accesspress_pro_widgets_name'			=> 'google-plus-square',
				'accesspress_pro_widgets_title'			=> __( 'Google+', 'accesspress' ),
				'accesspress_pro_widgets_field_type'		=> 'text'
			),
			'pinterest' => array (
				'accesspress_pro_widgets_name'			=> 'pinterest-square',
				'accesspress_pro_widgets_title'			=> __( 'Pinterest', 'accesspress' ),
				'accesspress_pro_widgets_field_type'		=> 'text'
			),
			'youtube' => array (
				'accesspress_pro_widgets_name'			=> 'youtube-square',
				'accesspress_pro_widgets_title'			=> __( 'YouTube', 'accesspress' ),
				'accesspress_pro_widgets_field_type'		=> 'text'
			),
			'vimeo' => array (
				'accesspress_pro_widgets_name'			=> 'vimeo-square',
				'accesspress_pro_widgets_title'			=> __( 'Vimeo', 'accesspress' ),
				'accesspress_pro_widgets_field_type'		=> 'text'
			),
			'flickr' => array (
				'accesspress_pro_widgets_name'			=> 'flickr',
				'accesspress_pro_widgets_title'			=> __( 'Flickr', 'accesspress' ),
				'accesspress_pro_widgets_field_type'		=> 'text'
			),
			'dribbble' => array (
				'accesspress_pro_widgets_name'			=> 'dribbble',
				'accesspress_pro_widgets_title'			=> __( 'Dribbble', 'accesspress' ),
				'accesspress_pro_widgets_field_type'		=> 'text'
			),
			'dribbble' => array (
				'accesspress_pro_widgets_name'			=> 'stumbleupon',
				'accesspress_pro_widgets_title'			=> __( 'Stumbleupon', 'accesspress' ),
				'accesspress_pro_widgets_field_type'		=> 'text'
			),
			'tumblr' => array (
				'accesspress_pro_widgets_name'			=> 'tumblr-square',
				'accesspress_pro_widgets_title'			=> __( 'Tumblr', 'accesspress' ),
				'accesspress_pro_widgets_field_type'		=> 'text'
			),
			'instagram' => array (
				'accesspress_pro_widgets_name'			=> 'instagram',
				'accesspress_pro_widgets_title'			=> __( 'Instagram', 'accesspress' ),
				'accesspress_pro_widgets_field_type'		=> 'text'
			),
			'lastfm' => array (
				'accesspress_pro_widgets_name'			=> 'skype',
				'accesspress_pro_widgets_title'			=> __( 'Skype', 'accesspress' ),
				'accesspress_pro_widgets_field_type'		=> 'text'
			),
			'soundcloud' => array (
				'accesspress_pro_widgets_name'			=> 'soundcloud',
				'accesspress_pro_widgets_title'			=> __( 'SoundCloud', 'accesspress' ),
				'accesspress_pro_widgets_field_type'		=> 'text'
			),
		);
