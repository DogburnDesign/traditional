...
/**
 * Adds accesspress_pro_Flickr_Stream widget.
 */
add_action( 'widgets_init', create_function( '', 'register_widget( "accesspress_pro_flickr_stream" );' ) );
class Accesspress_Pro_Flickr_Stream extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
	 		'accesspress_pro_flickr_stream',
			'AP : Flickr Stream',
			array(
				'description'	=> __( 'Displays your Flickr photos.', 'accesspress' )
			)
		);
	}
	 ...
	 */
	 private function widget_fields() {
		$fields = array(
			...
			// Other fields
			'flickr_id' => array (
				'accesspress_pro_widgets_name'			=> 'flickr_id',
				'accesspress_pro_widgets_title'			=> __( 'Flickr ID', 'accesspress' ),
				'accesspress_pro_widgets_field_type'		=> 'text'
			),
			'photo_count' => array (
				'accesspress_pro_widgets_name'			=> 'photo_count',
				'accesspress_pro_widgets_title'			=> __( 'Number of Photos', 'accesspress' ),
			...
			'photo_type' => array (
				'accesspress_pro_widgets_name'			=> 'photo_type',
				'accesspress_pro_widgets_title'			=> __( 'Type (user or group)', 'accesspress' ),
				'accesspress_pro_widgets_field_type'		=> 'select',
				'accesspress_pro_widgets_field_options'	=> array(
					'user' 		=> 'User',
					'group' 	=> 'Group'
			...
			'photo_display' => array (
				'accesspress_pro_widgets_name'			=> 'photo_display',
				'accesspress_pro_widgets_title'			=> __( 'Display', 'accesspress' ),
				'accesspress_pro_widgets_field_type'		=> 'select',
				'accesspress_pro_widgets_field_options'	=> array(
					'latest'	=> 'Latest',
					'random' 	=> 'Random'
