...
$accesspress_pro_blog_cat = empty($accesspress_pro_settings['blog_cat']) ? ' ' : $accesspress_pro_settings['blog_cat'];
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php 
	if($accesspress_pro_show_posted_date == 1 && has_category( $accesspress_pro_blog_cat)):
	accesspress_pro_posted_on(); 
		...
		if(($accesspress_pro_post_type=='portfolio' && $accesspress_pro_portfolio_show_socials == 1 ) || ($accesspress_pro_post_type=='events' && $accesspress_pro_event_show_socials == 1 ) || has_category( $accesspress_pro_blog_cat)):
		?>
