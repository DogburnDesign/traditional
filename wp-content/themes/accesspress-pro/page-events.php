...
// $accesspress_pro_event_post_per_page = $accesspress_pro_settings['event_post_per_page'];
...
<?php }
		...
		<?php
			$args = array (
	         ...
	         'post_status' => 'publish',
	         'posts_per_page' => -1,
	         //'meta_key' => 'accesspress_pro_event_day',
		...
		<?php edit_post_link( __( 'Edit', 'accesspress_pro' ), '<footer class="entry-footer"><span class="edit-link">', '</span></footer>' ); ?>
		</div><!-- #primary -->
